<template>
    <RouterLink to="/ticket-detail" class="grid grid-cols-3 gap-3 p-5 items-start">
      ...
      <div class="col-span-2">
        ...
        <div class="grid grid-cols-2 mt-2 gap-1">
          <button class="bg-[#FFD600] rounded-lg p-2 text-black text-[10px] font-bold">{{ sellingTicketText }}</button>
