<template>
    <nav class="px-2 sm:px-4 py-2.5 hidden lg:block fixed w-full top-0 left-0 bg-transparent bg-gradient-to-b from-black to-transparent"
        :class="{ 'bg-black bg-opacity-45': isScrolled }" style="z-inde,'text-sm'x: 99;">
    ...
    <div class="block lg:hidden fixed w-100 bottom-0 left-0 right-0 z-[99]">
        ...
        <div class="nav-bottom-bar flex justify-center items-center justify-between p-5">
            <RouterLink to="/" class="flex flex-col items-center" v-slot="{ isActive }">
                ...
                <div :class="[isActive ? 'text-yellow' : 'text-white', 'text-center','text-sm']">Home</div>
            </RouterLink>
            <RouterLink to="/place-to-go" class="flex flex-col items-center"  v-slot="{ isActive }">
                ...
                <div :class="[isActive ? 'text-yellow' : 'text-white', 'text-center','text-sm']">Place To Go</div>
            </RouterLink>
            <RouterLink to="/ticket" class="flex flex-col items-center" v-slot="{ isActive }">
                ...
                <div :class="[isActive ? 'text-yellow' : 'text-white', 'text-center','text-sm']">Tickets</div>
            </RouterLink>
            <RouterLink to="/contact" class="flex flex-col items-center" v-slot="{ isActive }">
                ...
                <div :class="[isActive ? 'text-yellow' : 'text-white', 'text-center','text-sm']">Contact Us</div>
            </RouterLink>
        </div>
    </div>
</template>
