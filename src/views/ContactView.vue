            ...
            <div
                    ...
                    <div class="w-full lg:max-w-xl">
                        ...
                        <form class="mt-8 space-y-6" action="#">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                <div>
                                    <label for="name"
                                        class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">First
                                        Name</label>
                                ...
                                <div>
                                    <label for="name"
                                        class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Last
                                        Name</label>
                                    <input type="text" name="name" id="name"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full"
                            ...
                            <label for="message" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">What
                                can we help
                                you with?</label>
                            ...
                            <button type="submit"
                                class="px-5 py-2 float-end text-base font-medium text-center text-white bg-blue rounded-lg hover:bg-[#3a7e9b] ">Submit</button>
                ...
                <div>
                    ...
                    <div class="mt-5">
                        ...
                        <iframe class="rounded-xl w-full mt-4 h-[38vh] shadow-lg"
